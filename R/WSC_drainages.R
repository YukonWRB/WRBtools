...
)
{
  ...
  tryCatch({
    ...
    if (active_only == TRUE){#Retain only active stations
      poly <- dplyr::filter(poly, .data$Status == "active")
    }
    #Write to file
