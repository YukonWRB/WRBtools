...
#'
#' Downloads and minimally processes precipitation rasters generated by the Canadian Precipitation Analysis (CaPA) System, clips them to a designated province/region, and saves them to a designated location.
#'
