...
#'
#' Downloads and minimally processes precipitation rasters generated by the Canadian Precipitation Analysis (CaPA) System [HRDPA](https://eccc-msc.github.io/open-data/msc-data/nwp_hrdpa/readme_hrdpa_en/), clips them to a designated province/region, and saves them to a designated location.
#'
